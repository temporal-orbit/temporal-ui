...
export interface SliderProps
	extends CoreSliderProps<React.ReactNode>, Omit<React.InputHTMLAttributes<HTMLInputElement>, "max" | "min" | "step"> {}
			...
			>
				<ArkSlider.Control data-with-value={showValue}>
					...
					<ArkSlider.Thumb index={0}>
						<ArkSlider.HiddenInput ref={ref} data-testid={testId ? `${testId}--input` : undefined} />
